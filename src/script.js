...
import mineIconBarImg from "./assets/images/mine-bar.png";
import mineIconImg from "./assets/images/mine-icon.png";
import flagIconImg from "./assets/images/flag-icon.png";
import crossIcon from "./assets/images/cross-small.svg";
import clickSoundSrc from "./assets/sounds/markcut.mp3";
import flagSoundSrc from "./assets/sounds/soundcut.mp3";
import winSoundSrc from "./assets/sounds/victory.mp3";
...
minesLeftImage.src = mineIconImg;
minesLeftImage.alt = "";
...
flagesLeftImage.src = flagIconImg;
flagesLeftImage.alt = "";
